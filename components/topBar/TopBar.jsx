    ...
    >
      <Toolbar>
        ...
        <Typography variant="h5" style={{ flexGrow: 1 }}>
          PhotoShareApp
          {props.loginUser && ` Version: ${version}`}
        </Typography>

        {/* Display greeting to Login User*/}
        <Typography color="#EEF7FF" variant="h5" style={{ flexGrow: 1 }}>
        ...
        {props.loginUser && (
          <Typography color="#EEF7FF" variant="h5">
          ...
          <form onSubmit={handlePhotoSubmit} style={{ flexGrow: 1 }}>
            ...
            {uploadInput && (
              <IconButton type="submit">
                <CloudUpload style={{ color: "#CDE8E5" }} fontSize="large" />
              </IconButton>
            )}
          </form>
        )}
        ...
        <React.Fragment>
          ...
          <IconButton title="Log out your account" onClick={handleLogoutPromptClick} variant="contained" >
            <ExitToApp style={{ color: "#ffb3ba" }} fontSize="large" />
          </IconButton>
          ...
          <Snackbar
            ...
            action={(
              <IconButton color="#ffb3ba" onClick={handleLogoutPromptClose}>
                <CloseRounded />
              </IconButton>
            )}
          />
        ...
        {props.loginUser && (
          <React.Fragment>
            ...
            <IconButton title="Delete your account forever" onClick={handleAlertOpen} variant="contained" >
              <DeleteForeverIcon style={{ color: "#ffb3ba" }} fontSize="large" />
            </IconButton>
            {/* alert prompt */}
            <Dialog
