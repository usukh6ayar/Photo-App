    ...
    <HashRouter>
      <div>
        <Grid container spacing={1}>
          ...
          {/* Sidebar View */}
          <Grid item sm={3} >
            <Paper className="side-bar" elevation={3} style={{ backgroundColor: "#CDE8E5", margin: '3%', border: "4px solid #5B89A6" }}>
          ...
          {/* Main View */}
          <Grid item sm={9} >
            <Paper className="cs142-main-grid-item" elevation={3} style={{ backgroundColor: "#CDE8E5", height: '100%', marginTop: '1%', marginRight: '2%', border: "4px solid #5B89A6" }}>
